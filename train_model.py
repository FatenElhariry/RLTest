...
from common_functions import generate_state_frame_stack_from_queue, write_updates
...
if __name__ == '__main__':
    ...
    for e in range(STARTING_EPISODE, ENDING_EPISODE+1):
        ...
        write_updates(state_frame_stack_queue)
        ...
        if e % SAVE_TRAINING_FREQUENCY == 0:
            write_updates(f"game ended rwards:{total_reward}")
            agent.save('trial_{}'.format(e))
            plt.plot(rewardList)
            plt.xlabel("Episodes")
